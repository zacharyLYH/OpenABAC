...
const mockData = [
    ...
    {
        id: "0000002",
        contextDescription: "No access to development servers during maintenance",
    ...
    {
        id: "000016",
        contextDescription: "Restrict application access from personal mobile devices",
        operator: "NOT IN",
        entity: "DeviceTypeAccess",
    ...
    {
        id: "000019",
        contextDescription: "Project access for users active within the last month",
        operator: ">",
    ...
    {
        id: "000020",
        contextDescription: "No project access for users inactive for over 6 months",
        operator: "<",
        entity: "UserLastActivity",
