        ...
        <Tabs defaultValue="overview" className="space-y-4">
            ...
            <TabsContent value="overview" className="space-y-4">
                <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
                    <TabSectionCard title="#Users" value="$45,231.89" description="+20.1% from last month" icon={<User className="h-5 w-5" />} />
                    <TabSectionCard title="#Policies" value="+2350" description="+180.1% from last month" icon={<Scroll className="h-5 w-5" />} />
                    <TabSectionCard title="#Actions" value="+12,234" description="+19% from last month" icon={<Move className="h-5 w-5" />} />
                    <TabSectionCard title="#Context" value="+573" description="+201 since last hour" icon={<Container className="h-5 w-5" />} />
